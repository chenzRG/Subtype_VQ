...
#DEG
DEGAll <- read.csv(file = 'data.csv',header=TRUE,row.name = 1)
symbols <- DEGAll$symbol
hg<-bitr(symbols,fromType="SYMBOL",toType=c("ENTREZID","ENSEMBL","SYMBOL"),OrgDb="org.Hs.eg.db")
